...
namespace NutEnum
{
	static ELogLevel ToELogLevel(const QString& s)
	{
	...
	static ELogGroup ToELogGroup(const QString& s)
	{
...
namespace
{
	...
	static QTextBrowser* p_texts_ = nullptr;
};
...
#define ENUM_TO_LEVEL(e) g_level_map.insert(ELogLevel::e,#e); 
	static void InitializeLogger(QTextBrowser* p,QComboBox* cbl, QComboBox* cbg)
	{
		p_texts_ = p;
...
#undef ENUM_TO_LEVEL
	...
	static void Filter(ELogGroup group, ELogLevel level)
	{
		p_texts_->clear();
